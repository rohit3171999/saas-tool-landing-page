        ...
        <section id="signup" className="bg-indigo-600 py-20">
            <div className="container mx-auto px-4 text-center">
                ...
                <p className="text-indigo-200 mt-4 max-w-2xl mx-auto">
                    Join thousands of teams who are already boosting their productivity. No credit card required.
                </p>
                ...
                <div className="mt-8 max-w-lg mx-auto">
                    <form className="space-y-4">
                        <div>
                            <input type="text" placeholder="Your Name" required className="w-full px-4 py-3 rounded-md text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-400 transition" />
                        </div>
                        <div>
                            <input type="email" placeholder="Your Email Address" required className="w-full px-4 py-3 rounded-md text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-400 transition" />
                        </div>
                        <div>
